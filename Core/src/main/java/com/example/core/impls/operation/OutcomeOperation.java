...
public class OutcomeOperation extends AbstractOperation {
    ...
    public OutcomeOperation(long id, Calendar dateTime, String addInfo, Source fromSource, Source toSource, BigDecimal amount, Currency currency) {
    ...
    public OutcomeOperation(long id, Source fromSource, Source toSource, BigDecimal amount, Currency currency) {
        super(id);
        this.fromSource = fromSource;
        this.toSource = toSource;
        this.amount = amount;
    ...
    public OutcomeOperation(Source fromSource, Source toSource, BigDecimal amount, Currency currency) {
        this.fromSource = fromSource;
        this.toSource = toSource;
        this.amount = amount;
        this.currency = currency;
